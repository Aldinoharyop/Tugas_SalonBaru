        ...
        <div class="row">
          <div class="col-sm-12">
            <ul class="clearfix category-item" id="protfolio-msnry">
              ...
              <?php foreach ($categoryis as $category) {?>
              <!-- Single Portfolio-->
              <li class="single-port-item <?php echo $category->id_category; ?>">

                  <div class="layanan-info">
                    <h3 class="about-subtitle"><?php echo $category->nama; ?> Treatment</h3>
                    <?php foreach ($model_paket->get_category_from_service($category->id_category) as $services) {?>
                        <h5><span><?php echo $services->nama; ?></span> Rp <?php echo $services->harga; ?>,-</h5>
						<?php } ?>
                  </div>
              </li>
              <!--/ single portfolio -->
