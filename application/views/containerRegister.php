		...
		<div class="container" align="center">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<br><br>
		<a href="<?php echo base_url()?>index.php/Control_login/tambah_customer"><button type="button" class="btn btn-outline-primary.btn-lg">Customer</button></a>
		<a href="<?php echo base_url()?>index.php/Control_login/tambah_admin"><button type="button" class="btn btn-outline-secondary.btn-lg">Administrator</button></a>
		<a href="<?php echo base_url()?>index.php/Control_login/tambah_pegawai"><button type="button" class="btn btn-outline-success.btn-lg">Pegawai</button></a>
				</div>
			</div>
		</div>
