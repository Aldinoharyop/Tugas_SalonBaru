            ...
            <div class="nav-inner">
              <nav class="primary-nav">
                <div class="clearfix nav-wrapper">
                  <a href="<?php echo base_url() ?>welcome" class="left brand-logo menu-smooth-scroll" data-section="#home">
                  ...
                  <ul class="right static-menu">
                    ...
                    <li>
                      <a href="<?php echo base_url()?>index.php/Contact" data-section="#contact" class="menu-smooth-scroll">
            ...
            <div class="col-md-10 col-md-offset-1 funfact-box">
              <div class="card-panel white">
                ...
                <div class="row dashboard-menu center-align">
                  <div class="col-xs-4">
                    <a href="<?php anchor('admin/reservation/') ?>">
